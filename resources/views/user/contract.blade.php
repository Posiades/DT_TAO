        ...
        <div class="inquiry-item col-lg-6">
          ...
          <form id="form" class="form-group flex-wrap">
            <div class="form-input col-lg-12 d-flex mb-3">
              <input type="text" name="email" placeholder="Viết tên của bạn ở đây" class="form-control ps-3 me-3 mb-3">
            ...
            <div class="col-lg-12 mb-3">
              <input type="text" name="email" placeholder="Viết chủ đề của bạn" class="form-control ps-3">
            </div>
            <div class="col-lg-12 mb-3">
              <textarea placeholder="Viết nội dung của bạn" class="form-control ps-3" style="height:150px;"></textarea>
            </div>
          </form>
            <button class="btn btn-dark btn-medium text-uppercase btn-rounded-none">Gửi</button>
        </div>
      </div>
    </div>
  </div>
