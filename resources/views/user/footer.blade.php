          ...
          <div class="row d-flex flex-wrap justify-content-between">
            <div class="col-lg-3 col-sm-6 pb-3">
              <div class="footer-menu">
                ...
                <p>Shop iPhone của chúng tôi cam kết cung cấp sản phẩm chính hãng, dịch vụ tận tâm, và trải nghiệm mua sắm an toàn tuyệt đối.</p>
            ...
            <div class="col-lg-2 col-sm-6 pb-3">
              <div class="footer-menu text-uppercase">
                <h5 class="widget-title pb-2">Đường dẫn</h5>
            ...
            <div class="col-lg-3 col-sm-6 pb-3">
              <div class="footer-menu contact-item">
                ...
                <p>Bạn có bất kỳ thắc mắc hoặc gợi ý nào không? <a href="mailto:">tnv240803@gmail.com</a>
                </p>
                <p>Nếu bạn cần hỗ trợ? Chỉ cần gọi cho chúng tôi. <a href="">+84 033 674 5555</a>
                </p>
              </div>
            </div>
          </div>
